...
STUDIO_NAME = _("EIA Education Studio")
STUDIO_SHORT_NAME = _("EIA Studio")
FEATURES = {
    'GITHUB_PUSH': False,
    ...
    'STUDIO_REQUEST_EMAIL': 'brenton.kreiger@eiabridges.org',
...
#Updated May 16, 2020 by Brenton
EDX_ROOT_URL = ''
...
# pretty sure this is where the log out issue occurs, but haven't fixed it for fear or breaking
LMS_BASE = None
...
EMAIL_USE_TLS = True
#EMAIL_HOST_USER = ''
EMAIL_HOST_USER = 'brenton.kreiger@eiabridges.org'
#EMAIL_HOST_PASSWORD = ''
EMAIL_HOST_PASSWORD = 'Sweetdreams1!'
