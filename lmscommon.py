...
PLATFORM_NAME = _('EIA Education')
PLATFORM_DESCRIPTION = _('An Online Learning Platform for the EIA Bridge Program')
CC_MERCHANT_NAME = PLATFORM_NAME

PLATFORM_FACEBOOK_ACCOUNT = "http://www.facebook.com/YourPlatformFacebookAccount"
PLATFORM_TWITTER_ACCOUNT = "@eiabridges"
...
#    'ENABLE_SYSADMIN_DASHBOARD': False,  # sysadmin dashboard, to see what courses are loaded, to delete & load courses
    ...
    'ENABLE_VERIFIED_CERTIFICATES': Ture,
...
OAUTH_OIDC_ISSUER = 'https://eiaeducation2.org/oauth2'
...
DEFAULT_FROM_EMAIL = 'education@eiabridges.org'
DEFAULT_FEEDBACK_EMAIL = 'education@eiabridges.org'
SERVER_EMAIL = 'education@eiabridges.org'
TECH_SUPPORT_EMAIL = 'education@eiabridges.org'
CONTACT_EMAIL = 'education@eiabridges.org'
BUGS_EMAIL = 'education@eiabridges.org'
UNIVERSITY_EMAIL = 'education@eiabridges.org'
PRESS_EMAIL = 'education@eiabridges.org'
FINANCE_EMAIL = 'brenton.kreiger@eiabridges.org'
...
TIME_ZONE = 'America/Denver'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
...
PAYMENT_SUPPORT_EMAIL = 'brenton.kreiger@eiabridges.org'
...
API_ACCESS_MANAGER_EMAIL = 'education@eiabridges.org'
API_ACCESS_FROM_EMAIL = 'education@eiabridges.org'
